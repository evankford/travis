...
module.exports = {
	// Project Identity
	appName: 'travis', // Unique name of your project
	type: 'theme', // Plugin or theme
	slug: 'travis', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
	...
	files: [
		// If this has length === 1, then single compiler
		{
			...
			entry: {
				...
				main: './src/customizer.js', // C`ould be a string
			},
		},
		{
			name: 'theme',
			entry: {
				...
				// code splitting automatically. When using ES6 modules, forget
				// global namespace pollutions 😉
				main: './src/theme.js', // Could be a string
			},
	...
	watch: '(./inc/*php|./template-parts/*.php|./*.php)',
